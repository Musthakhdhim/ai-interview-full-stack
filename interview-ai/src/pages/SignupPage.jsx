...
export default function SignupPage() {
  ...
  const handleSignup = async (e) => {
    ...
    const result = await dispatch(register({
      ...
      acceptTermsAndConditions: agreedToTerms,
    }));

    if (register.fulfilled.match(result)) {
      dispatch(setPendingSignup({ name: userName, email, role }));
          ...
          <CardContent>
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-2 gap-3 mt-6">
                ...
                <Button variant="outline" type="button" onClick={() => handleSocialAuth('github')}>
